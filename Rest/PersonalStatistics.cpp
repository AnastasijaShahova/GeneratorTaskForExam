...
PersonalStatistics::PersonalStatistics()
{
    ...
    resource_->set_path( "/repsonalRating");
...
std::shared_ptr<Resource> PersonalStatistics::get_resource() const
{
    return resource_;
}

std::string PersonalStatistics::to_json(std::vector<user_stat> stat)
{
...
void PersonalStatistics::post_handler(const std::shared_ptr<Session> session)
{
...
std::string PersonalStatistics::from_json(const Bytes& body)
{
